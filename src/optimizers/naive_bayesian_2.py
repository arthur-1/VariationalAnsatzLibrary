...
class NaiveBayesian2:
    ...
    def optimize(self, num_vars, objective_function, initial_point):
        ...
        for i in range(num_vars):
            bounds_lst.append(0)
            bounds_lst.append(2 * np.pi)
        bounds = np.array(bounds_lst).reshape((num_vars, 2))
        bo = bayesian_optimisation(self.maxiter, objective_function, bounds)
        print(bo)
